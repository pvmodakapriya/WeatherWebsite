...
function weatherDetails(info){
    if(info.cod == "404"){
        ...
        if(id == 800){
            wIcon.src = "D:/weatherwebsite/clear.png";
        } else if (id >= 200 && id <= 232){
            wIcon.src = "D:/weatherwebsite/drizzle.png";
        } else if (id >= 600 && id <= 622){
            wIcon.src = "D:/weatherwebsite/snowy.png";
        } else if (id >= 701 && id <= 781){
            wIcon.src = "D:/weatherwebsite/haze.png";
        } else if (id >= 801 && id <= 804){
            wIcon.src = "D:/weatherwebsite/cloud.png";
        } else if ((id >= 300 && id <= 321) || (id >= 500 && id <= 531)){
            wIcon.src = "D:/weatherwebsite/rainy.png";
        }
